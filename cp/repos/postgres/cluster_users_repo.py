...
def list_database_users(dns_address: str) -> list[DatabaseUser]:
    try:
        ...
        logger.debug("Cluster user query failed [operation=cluster_users.list_database_users]")
...
def create_database_user(dns_address: str, username: str, password: str) -> None:
    try:
        ...
        logger.debug("Cluster user query failed [operation=cluster_users.create_database_user]")
...
def remove_database_user(dns_address: str, username: str) -> None:
    try:
        ...
        logger.debug("Cluster user query failed [operation=cluster_users.remove_database_user]")
...
def revoke_database_user_role(dns_address: str, username: str, role: str) -> None:
    try:
        ...
        logger.debug("Cluster user query failed [operation=cluster_users.revoke_database_user_role]")
        raise translate_database_error(err, "cluster_users.revoke_database_user_role") from err
...
def update_database_user_password(
    ...
    try:
        ...
        logger.debug("Cluster user query failed [operation=cluster_users.update_database_user_password]")
        raise translate_database_error(err, "cluster_users.update_database_user_password") from err
