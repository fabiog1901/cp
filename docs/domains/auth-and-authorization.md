...
| Layer | Files |
| --- | --- |
| App integration | `cpkit.create_cpkit_bundle` in `cp/main.py` |
...
| Change | Start Here |
| --- | --- |
| Change app auth callbacks | `cp/main.py` |
...
| Change API keys | `cpkit/cpkit/auth/`; CP supplies only bundle callbacks in `cp/main.py` |
