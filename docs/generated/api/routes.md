...
| `GET` | `/playbooks/{name}` | `cp.api.admin.playbooks.get_playbook` | `PlaybookResponse` |
| `POST` | `/playbooks/{name}` | `cp.api.admin.playbooks.save_playbook` | `PlaybookVersionResponse` |
| `DELETE` | `/playbooks/{name}/{version}` | `cp.api.admin.playbooks.delete_playbook_version` | `PlaybookVersionResponse` |
| `GET` | `/playbooks/{name}/{version}` | `cp.api.admin.playbooks.get_playbook_version` | `PlaybookVersionResponse` |
| `PUT` | `/playbooks/{name}/{version}` | `cp.api.admin.playbooks.set_default_playbook` | `-` |
...
| `GET` | `/settings` | `cp.api.admin.settings.list_settings` | `-` |
| `GET` | `/settings/{setting_id}` | `cp.api.admin.settings.get_setting` | `-` |
| `PATCH` | `/settings/{setting_id}` | `cp.api.admin.settings.update_setting` | `-` |
| `PUT` | `/settings/{setting_id}/reset` | `cp.api.admin.settings.reset_setting` | `-` |
